...
#Enter your name: Ankit Jandial
#Enter your SID: 21102102
#Enter the name of the department: Civil
#Enter your CGPA: 9.6
#Hey, Ankit Jandial Here!
#My SID is 21102102 
...
#Enter the string:Hello my name is Ankit
#Yes
...
#Enter the 3rd side of triangle: 19
#Triangle can not be formed
